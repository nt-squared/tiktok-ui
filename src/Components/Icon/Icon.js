...
export const ActiveHomeIcon = ({ width = '32px', height = '32px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ActiveFollowingIcon = ({ width = '32px', height = '32px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const VideoIcon = ({ width = '32px', height = '32px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ActiveVideoIcon = ({ width = '32px', height = '32px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
// ===============================
// Discover Container Icons
// ===============================

export const HashIcon = ({ width = '16px', height = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const NoteIcon = ({ width = '16px', height = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MusicNoteIcon = ({ width = '16px', height = '16px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const EllipsisIcon = ({ width = '24px', height = '24px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
